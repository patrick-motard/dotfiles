hs.hotkey.bind(hyper, "e", "Window ← 1/2", function()
...
hs.hotkey.bind(hyper, "n", "Window ← Screen", function()
	local win = hs.window.focusedWindow()
	if not win then
		return
	end
...
hs.hotkey.bind(hyper, "o", "Window → Screen", function()
	local win = hs.window.focusedWindow()
	if not win then
		return
	end
...
hs.hotkey.bind(hyper, "i", "Window → 1/2", function()
	local win = hs.window.focusedWindow()
	if not win then
		return
	end
...
hs.hotkey.bind(hyper, "f", "Window Maximize", function()
	local win = hs.window.focusedWindow()
	if not win then
		return
	end
...
-- Note: The performancs for this is poor. Don't use.
...
hs.hotkey.bind(hyper, "a", "Hints", function()
...
hs.hotkey.bind(ergo_hyper, "s", "Window 1/3 shrink -5% |← →|", function()
	thirds_expand(true)
end)

hs.hotkey.bind(ergo_hyper, "g", "Window 1/3 expand +5% |← →|", function()
	thirds_expand(false)
end)

hs.hotkey.bind(ergo_hyper, "1", "Window left 1/3", function()
	thirds("left")
end)

hs.hotkey.bind(ergo_hyper, "2", "Window middle 1/3", function()
	thirds("center")
end)

hs.hotkey.bind(ergo_hyper, "3", "Window right 1/3", function()
	thirds("right")
end)
